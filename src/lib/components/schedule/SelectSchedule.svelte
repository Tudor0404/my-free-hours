...
<button
	class="flex flex-row justify-between btn variant-outline-surface"
	use:popup={schedulePopup}
	type="button"
>
	<span class="capitalize">{selectedSchedule?.name ?? 'Select a schedule'}</span>
	<Icon
...
<div class="p-2 py-2 w-72 shadow-xl card" data-popup={target}>
	...
	<div class="overflow-y-auto py-2 space-y-2 w-full h-60">
